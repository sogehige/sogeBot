...
export class addQuickActions1621029097170 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "quickaction" ("id" varchar PRIMARY KEY NOT NULL, "userId" varchar NOT NULL, "order" integer NOT NULL, "title" varchar NOT NULL, "action" text NOT NULL)`);
  }
